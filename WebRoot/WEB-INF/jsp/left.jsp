		...
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr valign="top">
		    <td class="left_nav_bgshw" height="50">
			  ...
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="user/preAddUser" target="main">添加用户</a></img></p>
			</td>
		  </tr>
		  ...
		  <tr valign="top"><td height="100%" align="center"><div class="copycct"><br /><strong>技术支持：</strong><br><strong>xxxxxxxx有限公司</strong><br>Http://www.deepsl.org</div></td></tr>
